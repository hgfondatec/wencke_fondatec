...
with artikelbestand_vms_ref as (
    ...
    from {{ ref('vms_bronze_artikel_bestand') }}

),

artikelbestand_vms as (
    ...
    select
        ...
        '42_L1'::varchar(20)      as mandant_lager_key
    from artikelbestand_vms_ref
    ...
    select
        ...
        '42'::varchar(10)         as mandant_id,
        '42_L2'::varchar(20)      as mandant_lager_key
    from artikelbestand_vms_ref
    ...
    select
        ...
        '42'::varchar(10)         as mandant_id,
        '42_L3'::varchar(20)      as mandant_lager_key
    from artikelbestand_vms_ref

)

select *
from artikelbestand_vms